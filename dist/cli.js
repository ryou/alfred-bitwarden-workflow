...
var projectRootPath = path_1.resolve(__dirname, '../');
var bwPath = (projectRootPath + "/node_modules/.bin/bw").replace(/ /g, '\\ ');
/**
 * envファイルを生成する
 *
 * @param sessionKey
...
var generateEnvFile = function (sessionKey) {
    ...
    var outputPath = projectRootPath + "/.env";
...
program
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, logout().catch(function (error) { return console.log(error.message); })];
            case 1:
                _a.sent();
                console.log('progress login process.');
                return [4 /*yield*/, login(username, password, code)];
            case 2:
                sessionKey = _a.sent();
